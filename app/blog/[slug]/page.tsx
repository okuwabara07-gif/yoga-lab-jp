      ...
      <div style={{fontSize:'0.9rem',lineHeight:1.9}}><MDXRemote source={post.content} /></div>
        <div style={{marginTop:'3rem',borderTop:'1px solid #eee',paddingTop:'2rem'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(150px,1fr))',gap:'1rem'}}>
            ...
            <a href="https://port-fitness.jp/" target="_blank" rel="noopener noreferrer sponsored" style={{display:'block',padding:'1rem',border:'1px solid #e6f7ff',borderRadius:'12px',textDecoration:'none',background:'#f0faff'}}><div style={{fontSize:'1.5rem',marginBottom:'0.5rem'}}>💪</div><div style={{fontSize:'0.8rem',fontWeight:700,color:'#333',marginBottom:'0.25rem'}}>PORT女性専用</div><div style={{fontSize:'0.7rem',color:'#666'}}>ヨガ・エステ使い放題 →</div></a>
